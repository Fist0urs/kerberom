# This file comes from the amazing impacket tool by Alberto Solino (@agsolino)
# https://github.com/CoreSecurity/impacket/blob/master/impacket/dcerpc/v5/enum.py
